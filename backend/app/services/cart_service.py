...
class CartServise:
    ...
    def get_cart_details(self, cart_data: Dict[int, int]) -> CartResponse:
        ...
        products = self.product_repository.get_multyple_by_ids(product_ids)
        ...
        for product_id, quantity in cart_data.items():
            if product_id in products_dict:
                ...
                cart_item = CartItem(product_id=product.id, name=product.name, price=product.price, quantity=quantity,
